"""
ANALIZADOR FÚTBOL HEURÍSTICO - 6 Reglas jerárquicas
"""
import streamlit as st

class AnalizadorFutbolHeuristico:
    """
    ...
    def _procesar_stats(self):
        ...
        # Goles totales por partido (sumando ambos equipos)
        self.goles_ft = []
        for i in range(min(5, len(self.local.get('ultimos_5', [])), len(self.visitante.get('ultimos_5', [])))):
